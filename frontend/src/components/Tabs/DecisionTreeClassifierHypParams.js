/*
Name: DecisionTreeClassifierHypParams.js
  ...
  return(
    <Form.Group>
      ...
      <Col>
        ...
        <Form.Select id="crit" data-tip={HyperparamInfo("DecisionTreeClassifier", "crit")} onChange={crit_change} defaultValue="squared_error">{/**select input for criterion */}
